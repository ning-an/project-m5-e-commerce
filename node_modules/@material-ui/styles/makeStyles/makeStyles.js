...
function makeStyles(stylesOrCreator) {
  ...
  var useStyles = function useStyles() {
    ...
    if (process.env.NODE_ENV !== 'production') {
      var whitelistedComponents = ['MuiButton'];

      if (name && whitelistedComponents.indexOf(name) >= 0 && props.variant && !classes[props.variant]) {
        console.error(["Material-UI: You are using a variant value `".concat(props.variant, "` for which you didn't define styles."), "Please create a new variant matcher in your theme for this variant. To learn more about matchers visit https://material-ui.com/customization/components/#adding-new-component-variants."].join('\n'));
      }
    }
